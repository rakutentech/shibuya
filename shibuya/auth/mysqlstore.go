...
func (m *MySQLStore) encode(values map[interface{}]interface{}) (string, error) {
...
func (m *MySQLStore) insert(session *sessions.Session) error {
	...
	encoded, err := m.encode(session.Values)
	if err != nil {
		return err
	}
...
func (m *MySQLStore) decode(raw string, dest *map[interface{}]interface{}) error {
	var buff bytes.Buffer
